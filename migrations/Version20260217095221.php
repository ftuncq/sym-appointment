 ...
 */
final class Version20260217095221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE setting (id INT AUTO_INCREMENT NOT NULL, setting_key VARCHAR(64) NOT NULL, value TINYINT DEFAULT 0 NOT NULL, UNIQUE INDEX uniq_setting_key (setting_key), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
